...
## Objetivo do Projeto:
🔹Qual o volume total produzido? </br>
🔹Qual o índice de rejeição? </br>
🔹Como está a eficiência operacional? </br>
🔹Quanto tempo está sendo perdido com paradas? </br>
🔹A qualidade do processo está dentro do esperado? </br>
🔹Existe variação de desempenho ao longo dos meses? </br>
